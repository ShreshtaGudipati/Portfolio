  ...
  return (
    ...
    >
        ...
        <div>
            ...
            max-w-[15ch] 
            sm:max-w-[20ch] lg:max-w-[15ch] mt-5 mb-8 lg:mb-10'>Building Scalable Modern Websites for the Future</h2>
        ...
        <div className="hidden lg:block">
            ...
            bg-gradient-to-t from-sky-400 via-25% via-sky-400 
